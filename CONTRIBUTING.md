# Contributing to sepio-linkml

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
sepio-linkml. These guidelines are not strict rules.
...
The sepio-linkml team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the sepio-linkml technical leads
...
[issues]: https://github.com/sepio-framework/sepio-linkml/issues/
[pulls]: https://github.com/sepio-framework/sepio-linkml/pulls/
