...
EXAMPLEDIR = examples
SHEET_MODULE = release_subset_v1
...
GEN_DOC_ARGS = --template-directory $(DOCTEMPLATES)
...
examples/output: src/sepio_linkml/schema/sepio_linkml.yaml
	mkdir -p $@
